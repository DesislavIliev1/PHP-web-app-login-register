        ...
        <div class="row">
            <div class="col-12 col-sm-8 col-md-6 m-auto">
                ...
                <div id="swup" class="card border-0 shadow transition-fade mb-5">
                    <div class="card-body">
                        <form class=""  action="edit_inc.php" method="post">
                            ...
                            <div class="input-group">
                                 <input type="text" class="form-control my-4 py-2 reg-username" name="username" value="" >
                            ...
                            <div class="nav-link-container text-center">
                                <a class="nav-link link-primary my-3" href="index.php">Cancel</a>
                                <?php 
                                // showing the errors if we have
